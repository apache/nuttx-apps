...
typedef struct
{
  snd_interval_t intervals[SND_PCM_HW_PARAM_LAST_INTERVAL -
...
FAR const char *snd_pcm_access_name(const snd_pcm_access_t _access);
...
int snd_pcm_set_volume(FAR snd_pcm_t *pcm, int volume); /* volume: [0, 100] */
