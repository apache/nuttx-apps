/****************************************************************************
 * apps/examples/elf/tests/task/task.c
 *
...
/* NOTE: it is necessary for functions that are referred to by
 * function pointers pointer to be declared with global scope
 * (at least for ARM).
...
int main(int argc, char **argv)
{
  ...
  child_argv[1] = 0;
  child_pid = task_create(child_name, 50, 2048, child_task,
