/****************************************************************************
 * apps/games/NXDoom/src/doom/doomdef.h
 *
 ...
 *
 * DESCRIPTION:
 *   Internally used data structures for virtually everything, lots of other
 *   stuff.
 *
 ****************************************************************************/
...
/* Power up durations, how many seconds till expiration, assuming TICRATE is
 * 35 ticks/second.
 */
