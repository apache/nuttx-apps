/****************************************************************************
 * apps/games/NXDoom/src/doom/r_defs.h
 *
 ...
 *
 * Note: transformed values not buffered locally, like some DOOM-alikes
 * ("wt", "WebView") did.
 */
 ...
 *
 * Indeed, true color support is possible precalculating 24bpp
 * lightmap/colormap LUT. from darkening PLAYPAL to all black. Could even
 * use more than 32 levels.
 */
...
typedef struct drawseg_s
{
  ...
  /* Pointers to lists for sprite clipping, all three adjusted so [x1] is
   * first value.
   */
