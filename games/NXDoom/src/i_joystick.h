/****************************************************************************
 * apps/games/NXDoom/src/i_joystick.h
 *
 ...
 * comes from XINPUT_GAMEPAD_TRIGGER_THRESHOLD in xinput.h, and is scaled
 * here for the SDL_GameController trigger max value.
 */
