                                      ...
                                      int8_t *out_0)
{
    ...
    while (row_count)
    {
         ...
         * int16, and then cross-multiplied to obtain eight calculation results.
         */
        while (col_count)
        {
        ...
        for (int i = 0; i < 4; i++)
        {
            ch_out[i][0] = arm_nn_requantize(ch_out[i][0], *out_mult, *out_shift);
            ch_out[i][1] = arm_nn_requantize(ch_out[i][1], *out_mult, *out_shift);
