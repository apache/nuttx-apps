...
/* #udef ARCHIVE_CRYPTO_SHA256_OPENSSL */
...
/* #undef ARCHIVE_CRYPTO_SHA384_OPENSSL 1 */
...
#define HAVE_UNSIGNED_LONG_LO 1

/* Define to 1 if the system has the type `unsigned long long int'. */
#define HAVE_UNSIGNED_LONG_LONG_I 1
