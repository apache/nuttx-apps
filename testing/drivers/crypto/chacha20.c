...
static void test_chacha20(void **state)
{
  int fail = 0;
  int i;
...
{
  const struct CMUnitTest chacha20_tests[] = {
      cmocka_unit_test(test_chacha20),
  };

  return cmocka_run_group_tests(chacha20_tests, NULL, NULL);
}
