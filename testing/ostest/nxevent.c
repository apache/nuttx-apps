...
static void nxevent_test_rule1(nxevent_t *event)
{
  ...
  NXEVENT_TEST(nxevent_wait(event, 0), ~0);
  ...
  nxevent_post(event, 1 << 0);
  nxevent_post(event, 1 << 1);
  nxevent_post(event, 1 << 2);
  nxevent_post(event, 1 << 3);

  /* Case 2.6: post == 0xaaaaaaaa, wait == 0xaaaaaaaa */

  nxevent_yield();

  nxevent_post(event, 0xaaaaaaaa);
...
static void nxevent_test_rule0(nxevent_t *event)
{
  ...
  NXEVENT_TEST(nxevent_wait(event, 0), 0xf);
  ...
  NXEVENT_TEST(nxevent_wait(event, 0xf), 0xf);

  /* Case 2.6: post == 0xaaaaaaaa, wait == 0xaaaaaaaa */

  nxevent_yield();

  NXEVENT_TEST(nxevent_wait(event, 0xaaaaaaaa), 0xaaaaaaaa);
...
FAR static void *nxevent_thread2(pthread_addr_t arg)
{
  ...
  NXEVENT_TEST(nxevent_wait(event, 0xf0), 0xf0);

  /* Case 3.2: post == 0xff, wait == 0xff */

  nxevent_yield();

  nxevent_post(event, 0xf0);
...
void nxevent_test(void)
{
  ...
  NXEVENT_TEST(nxevent_tickwait(&event, ~0, 0), 0);

  /* Case 1.6: post == 0xf, trywait == 0xf */

  NXEVENT_TEST(nxevent_trywait(&event, 0xf), 0xf);
  ...
  NXEVENT_TEST(nxevent_wait(&event, 0xff), 0xff);
